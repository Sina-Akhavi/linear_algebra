...
target_face2_sliced = target_face2[:3:, ]

x = np.linalg.solve(F_sliced, target_face2_sliced)

a, b, c = x
Face = a * Face1 + b * Face2 + c * Face3

# plot_face(plt, Face1, edges, color='g')
# plot_face(plt, Face2, edges, color='b')
# plot_face(plt, Face3, edges, color='r')
plot_face(plt, TargetFace2, edges, color='black')
plot_face(plt, Face, edges, color='y')
